		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OPA Tests",
									"targetURL": "#student10comsaptrainingux402opaux402opa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student10comsaptrainingux402opaux402opa-display": {
								"semanticObject": "student10comsaptrainingux402opaux402opa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student10.com.sap.training.ux402.opa.ux402opa",
									"url": sap.ui.require.toUrl("student10/com/sap/training/ux402/opa/ux402opa")
								}
							}
						}
					}
